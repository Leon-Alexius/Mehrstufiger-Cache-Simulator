...
extern struct CacheStats* run_simulation_analyze(
    int cycles,
...
int main() {
    ...
    const char* input_filename[6] = {
        "src/assets/matrix_multiplication/ijk.csv",
        "src/assets/matrix_multiplication/ikj.csv",
        "src/assets/matrix_multiplication/jik.csv",
        "src/assets/matrix_multiplication/jki.csv",
        "src/assets/matrix_multiplication/kij.csv",
        "src/assets/matrix_multiplication/kji.csv"
    };
    ...
    for (int i = 0; i < 6; i++) {
        ...
        struct CacheStats* stats = run_simulation_analyze(
            cycles,
