...
run_test "./cache --l1-lines 256 --l2-lines 64 src/assets/matrix_multiplication/ijk.csv" "L1 cache lines count is greater than L2 cache lines count"

# Test 2: L1 latency greater than L2 latency or L2 latency greater than memory latency
run_test "./cache --l1-latency 13 --l2-latency 12 --memory-latency 100 src/assets/matrix_multiplication/ijk.csv" "L1 latency is greater than L2 latency"
run_test "./cache --l1-latency 4 --l2-latency 101 --memory-latency 100 src/assets/matrix_multiplication/ijk.csv" "L2 latency is greater than memory latency"
...
run_test "./cache --cycles -1 src/assets/matrix_multiplication/ijk.csv" "Cycles to simulate is less than 0"
