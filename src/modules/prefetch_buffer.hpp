...
/**
* @brief The prefetch buffer tries to increase read hits to reduce latency 
* @details This module will read from the memory and will wait according to the memory latency, and therefore making it
* slower.
* 
* @authors
